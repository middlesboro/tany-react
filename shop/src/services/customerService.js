...
const API_URL = `${import.meta.env.VITE_BACKEND_BASE_URL}${import.meta.env.VITE_API_URL}/customer`;
...
export const createEmailNotification = async (notification) => {
    const response = await authFetch(`${import.meta.env.VITE_BACKEND_BASE_URL}${import.meta.env.VITE_API_URL}/customer/email-notification`, {
        method: 'POST',
        headers: {
