  ...
  return (
    <div className="product !flex-col !items-start">
      ...
      {crossSellProducts && crossSellProducts.length > 0 && (
          <div className="w-full mt-4 pl-0 sm:pl-24">
              <div className="text-sm font-semibold text-gray-500 mb-2">Odporúčame dokúpiť:</div>
              <div className="flex flex-col gap-2">
                  {crossSellProducts.slice(0, 3).map((product) => (
                      <div key={product.id} className="flex items-center gap-3 bg-gray-50 p-2 rounded-lg border border-gray-100">
                          {/* Small Image */}
                          <div className="shrink-0">
                              {product.image ? (
                          ...
                          <div className="flex-1 min-w-0">
                              <Link to={`/produkt/${product.slug}`} className="text-sm font-medium text-gray-800 hover:text-[#2f6f4f] truncate block" title={product.title}>
                                  {product.title}
                              </Link>
                          ...
                          <button
                              ...
                              className="text-xs font-bold text-[#2f6f4f] border border-[#2f6f4f] hover:bg-[#2f6f4f] hover:text-white px-3 py-1 rounded transition-colors whitespace-nowrap"
                          >
