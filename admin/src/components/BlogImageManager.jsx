...
import { uploadBlogImage, deleteBlogImage } from '../services/blogAdminService';

const BlogImageManager = ({ blogId, image, onUploadSuccess }) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      await uploadBlogImage(blogId, selectedFile);
  ...
  return (
    <div className="mt-8 border-t pt-4">
      <h2 className="text-xl font-bold mb-4">Blog Image</h2>
